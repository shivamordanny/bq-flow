...
def configure_module_loggers():
    ...
    logging.getLogger('api_endpoint').setLevel(logging.DEBUG)
    logging.getLogger('bigquery_ai_functions').setLevel(logging.DEBUG)
    logging.getLogger('app_ui').setLevel(logging.DEBUG)
